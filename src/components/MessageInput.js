...
export const MessageInput = ({ onSendMessage, disabled, chatId }) => {
  ...
  return (
    <div className="bg-gray-100 p-4 flex justify-center">
      <form onSubmit={handleSubmit} className="flex items-center md:w-[75%]">
        <div className="flex-1 relative flex items-center">
          <textarea
            ...
            className="w-full py-5 px-3 pr-14 border text-black border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent resize-none min-h-[48px] max-h-32"
            rows={1}
            disabled={disabled}
          />
