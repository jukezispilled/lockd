      ...
      <form onSubmit={handleSubmit} className="flex items-center space-x-3 md:w-[75%]">
        <div className="flex-1 relative items-center">
          <textarea
            ...
            className="w-full p-3 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent resize-none min-h-[48px] max-h-32"
            rows={1}
            disabled={disabled}
          />
