...
export default function Tokenz({ publicKey, connected, signTransaction, connection, onTokenCreationSuccess }) {
  ...
  return (
    <div className='grid'>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div
                      className={`flex items-center space-x-2 w-full p-1 border-1 transition-colors duration-200 rounded-sm ${
                        isDraggingOver ? 'border-black bg-[#333] border-dashed' : 'border-[#333] border-solid'
                      }`}
                    ...
                    >
                      ...
                      <label
                        ...
                        className="cursor-pointer bg-black text-white py-2 px-3 focus:outline-none focus:ring-2 focus:ring-black focus:ring-opacity-50"
                      >
                        Choose File
                      </label>
      ...
      {chatCreationStatus && (
        <div className="bg-blue-50 border border-blue-200 p-2 mb-4">
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200 mb-6">
          ...
          <div className="space-y-3">
            {createdTokens.map((token) => (
              <div key={token.mint} className="bg-gray-50 p-4">
